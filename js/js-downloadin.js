...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            var updated_at_array = downloadfile.updated_at.split(" ");
            ...
            <div class="fb-share-button" data-href="`+ window.location.href +`" data-layout="button" data-size="large">
                <a href="https://www.facebook.com/sharer/sharer.php?u=`+ encodeURIComponent(window.location.href) +`&amp;src=sdkpreparse" class="btnMainColorBt typo-textAlignright" target="_blank">
                    SHARE
                    <img src="images/share.svg" alt="icon" class="icon--left" aria-hidden="true">
                </a>
            </div>
            `
